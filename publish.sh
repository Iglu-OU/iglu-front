...
url=`curl -H "Authorization: Bearer $NETLIFY_ACCESS_TOKEN" https://api.netlify.com/api/v1/sites/iglu-react-front/deploys`
...
curl -X POST -H "Authorization: Bearer $NETLIFY_ACCESS_TOKEN" -d "{}" "https://api.netlify.com/api/v1/sites/iglu-react-front/deploys/${temp##*|}/restore"
